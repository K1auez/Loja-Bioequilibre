        ...
        <div class="all-products">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<form method='get' action='./editar.php?id=" . $produto_id . "'>";
                            echo "<input type='hidden' name='id' value='" . $produto_id . "'>";
                            echo "<button class='edit-btn' type='submit'><ion-icon name='create-outline'></ion-icon></button>";
                            echo "</form>";

                            echo "<form method='post' action='./back-end/excluir.php'>";
                            echo "<input type='hidden' name='produto_id' value='" . $produto_id . "'>";
                            echo "<button class='edit-btn' type='submit'><ion-icon name='trash-bin-outline'></ion-icon></button>";
                            echo "</form>";
                            echo "</div>";
                    ...
                    <div class="product">
                        <a class="edit-btn" href="./adicionar.php"><ion-icon name="add-circle-outline"></ion-icon></a>
                    </div>
        </div>
